...
CREATE TABLE `funding_content` (
  ...
  CONSTRAINT `content_funding` FOREIGN KEY (`content_funding`) REFERENCES `funding_content` (`content_num`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `funding_option` (
  ...
  KEY `detail_funding_idx` (`option_funding`),
  CONSTRAINT `option_funding` FOREIGN KEY (`option_funding`) REFERENCES `funding_option` (`option_num`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-04 11:50:20
