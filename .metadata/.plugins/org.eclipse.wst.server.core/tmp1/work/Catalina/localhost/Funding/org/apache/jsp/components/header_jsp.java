 ...
 * Generated at: 2022-04-06 09:36:09 UTC
...
public final class header_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("let customer_id = \"");
      out.print(session.getAttribute("customer_id"));
      out.write("\";\n");
      out.write("if(customer_id == \"null\"){\n");
      out.write("	document.getElementById(\"loginZone\").innerHTML = '<div class=\"loginButton\">로그인</div>';\n");
      out.write("}else{\n");
      out.write("	document.getElementById(\"loginZone\").innerHTML = '<p class=\"signedIn_email\">'+customer_id.split(\"@\")[0]+' 님</p><div class=\"mypageButton\">마이페이지</div> <div class=\"logoutButton\">로그아웃</div>';\n");
      out.write("}\n");
      ...
      out.write("	e.stopPropagation();\n");
      out.write("	localStorage.setItem(\"pastURL\", location.href);\n");
      out.write("	location.href = \"/Funding/logout.do\";\n");
      out.write("})\n");
      out.write("$(document).on(\"click\", \".mypageButton\", function(e){\n");
      out.write("	e.stopPropagation();\n");
      out.write("	localStorage.setItem(\"pastURL\", location.href);\n");
