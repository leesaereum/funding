		...
		<div class="my__wrap">
			...
			<div class="tab__content" id="tab__2__content">
					...
					<ul class="list__box">
						...
						<c:forEach items="${funding}" var="funding">
							<li class="list__liner"><a
								href="/Funding/myorder_detail.do?order_num=${funding.order_num}"
				...
				<script type="text/javascript">
					...
					$(document).on("select", ".tab__1", function() {
				...
				<div class="my__formzone">
					...
					<div class="my__liner">
						...
						<input class="my__form__button" type="button" value="주소검색"
							onclick="goPopup();"> <input class="my__form__input long"
							name="address1" id="roadAddrPart1">
					</div>
					<div class="my__liner">
